...
func host_info_to_json(host_info Host_info_type) string {

	/*编码*/
	data, err := json.MarshalIndent(host_info, "", "   ")
	if err != nil {
...
func main() {
	...
	data := host_info_to_json(host_info)
	CreateFile("./HostInfo.txt", data)
